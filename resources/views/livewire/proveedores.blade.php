                ...
                <div class="col-sm-12 col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between row"
                            ...
                            <div class="">
                                <a wire:click='volver'
                                    class="btn border add-btn shadow-none mx-2 d-none d-md-block">Volver</a>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <b>Identificación:</b>
                                    <input wire:model='proveedor.intNumeroDoc' type="number" class="form-control"
                                ...
                                <div class="col-lg-6">
                                    <b>Razón Social:</b>
                                    <input wire:model='proveedor.varNombreRazon' type="text" class="form-control"
                                        placeholder="Nombre">
                                ...
                                <div class="col-lg-3">
                                    <b>Teléfono:</b>
                                    <input wire:model='proveedor.varTelefono' type="number" class="form-control"
                                ...
                                <div class="col-lg-3">
                                    <b>Correo:</b>
                                    <input wire:model='proveedor.varCorreo' type="email" class="form-control"
                                        placeholder="Correo">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input wire:model='proveedor.varNombreConta' type="text" class="form-control"
                                ...
                                <div class="col-lg-12">
                                    <b>Dirección:</b>
                                    <input wire:model='proveedor.varDireccion' type="text" class="form-control"
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input wire:model='proveedor.varTelefonoConta' type="text" class="form-control"
                                ...
                                <div class="col-lg-6">
                                    <b>Plazo (Días):</b>
                                    <input wire:model="proveedor.intPlazoEntr" type="number" class="form-control"
                            ...
                            <div class="card-body">
                                ...
                                <table class='table text-center'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr @if($proveedor['bolEstado']==false) class="table-danger" @endif>
                                            ...
                                            <td>
                                                ...
                                                <button wire:click="cambiarEstado({{ $proveedor['IdProveedores'] }})"
                                                    class="btn btn-success btn-sm ">Activar</button>
                                                @else
                                                <button
                                                    wire:click="cambiarEstado({{ $proveedor['IdProveedores'] }})"
                                                    class="btn btn-danger btn-sm icon-only">Inactivar</button>
                                                <button wire:click="editarproveedor({{ $proveedor['IdProveedores'] }})"
                                                    class="btn btn-warning btn-sm  icon-only">Editar</button>
                                                @endif
                                                <button wire:click="verproveedor({{ $proveedor['IdProveedores'] }})"
                                                    class="btn btn-info btn-sm icon-only">Ver</button>
                                            </td>
                                        </tr>
                                        @endforeach
