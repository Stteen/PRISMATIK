                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-info-light">
                                        <img src="https://cdn3d.iconscout.com/3d/premium/thumb/water-tap-3495483-2928753.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                                        <p class="mb-2">NAN</p>
                                        <h4>0</h4>
